...
| Skill | What it does |
|-------|----------------|
| [`api-friction-walkthrough`](api-friction-walkthrough/SKILL.md) | Reads integrator-facing docs/spec, picks 1–2 real use cases, checks the docs/spec against the use cases, and lists where someone would get stuck finishing them |
...
2. In Cursor or Claude, ask for an **API friction walkthrough** and point at your docs URL, files, or spec.
...
**Example ask:** “Run an API friction walkthrough on https://developers.example.com.”

## Install

### Cursor

Copy `api-friction-walkthrough/` to one of:

- **Project:** `.cursor/skills/api-friction-walkthrough/`
- **User (all projects):** `~/.cursor/skills/api-friction-walkthrough/`
...
- **Project:** `.claude/skills/api-friction-walkthrough/`
- **User:** `~/.claude/skills/api-friction-walkthrough/`

Or clone this repo and symlink the folder into your skills path.

## What `api-friction-walkthrough` is good for

This is a free, lightweight review of up to 2 use cases as chosen by the agent (unless you provide your own). Different walkthroughs can surface different findings if the use cases or scope change.
